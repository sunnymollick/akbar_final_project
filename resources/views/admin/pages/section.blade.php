...
<main>
    <div class="container-fluid">    
        ...
        <div class="card mb-4">
            <div class="card-body">
            <a href="{{ URL::to('create-section') }}" style="float:right" type="button" class="btn btn-primary">
             Add Section
            </a>
            </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered text-center " id="dataTable" width="100%" cellspacing="0">
                        ...
                        @foreach($allsections as $AC)
                        <tr>
                        <td>{{ $AC->batch}}</td>
                        <td>{{ $AC->title}}</td>
                        <td>
                            <a class="btn btn-info" href=" {{ URL:: to ('edit-section/'.$AC->id) }} ">Edit</a>
                            ...
                            <div class="modal" id="delete{{ $AC->id }}" align ="center">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <a class="btn btn-success" href=" {{ URL:: to ('delete-section/'.$AC->id) }} ">Yes</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
